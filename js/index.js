...
function handleDisplayTranscription(transcription, summary){
    transcriptionText.innerHTML = transcription + " In summary, " + summary
...
function handleDisplayingRecordingControlButtons() {
    ...
    handleHidingTranscription()

    //Handle the displaying of the elapsed recording time
    handleElapsedRecordingTime();
}

function handledHidingTranscription(){
    transcriptionContainer.classList.add("hide")
}
...
async function processAudio(recorderAudioAsBlob){
    var formdata = new FormData()
    formdata.append("audio_file", recorderAudioAsBlob, "Ndpwmy3s4QadCIi.mp3");
    var requestOptions = {
        method: 'POST',
        body: formdata,
        redirect: 'follow'
    ...
    fetch("https://whisper.lablab.ai/asr", requestOptions)
      ...
      .then(result =>  {
        console.log(result)
        const url = "http://localhost:5000/whisper"
        fetch(url, {
            method: 'POST', 
...
*/
async function playAudio(recorderAudioAsBlob) {
    processAudio(recorderAudioAsBlob)
